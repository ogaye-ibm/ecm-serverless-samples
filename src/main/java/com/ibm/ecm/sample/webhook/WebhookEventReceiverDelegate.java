...
public class WebhookEventReceiverDelegate {
    ...
    private static final Logger LOGGER = Logger.getLogger(WebhookEventReceiverDelegate.class);
    ...
    Response listenerDelegate(String eventJson, ServletContext context) {
        {
            LOGGER.info("Receiver called with payload: " + eventJson);

            String methodName = "listenerDelegate";
